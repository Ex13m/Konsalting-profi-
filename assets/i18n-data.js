...
window.KP = {
  ...
  ui: {
    ...
    sending:    { cs:"Odesílám…", en:"Sending…", ru:"Отправляю…", uk:"Надсилаю…", de:"Senden…", pl:"Wysyłam…" },
    slotTaken:  { cs:"Tenhle blok mezitím někdo zabral. Vyberte prosím jiný — kalendář je už aktuální.",
      en:"Someone has just taken this slot. Please pick another one — the calendar is up to date now.",
      ru:"Этот блок только что заняли. Выберите другой — календарь уже обновлён.",
      uk:"Цей блок щойно зайняли. Оберіть інший — календар уже оновлено.",
      de:"Dieser Block wurde gerade vergeben. Bitte wählen Sie einen anderen — der Kalender ist jetzt aktuell.",
      pl:"Ten blok właśnie ktoś zajął. Proszę wybrać inny — kalendarz jest już aktualny." },
    mailSent:   { cs:"Potvrzení jsme vám poslali e-mailem a termín máme zapsaný.",
      en:"We have emailed you the confirmation and the slot is booked.",
      ru:"Подтверждение отправили на почту, время закреплено за вами.",
      uk:"Підтвердження надіслали на пошту, час закріплено за вами.",
      de:"Die Bestätigung ist per E-Mail unterwegs, der Termin ist eingetragen.",
      pl:"Potwierdzenie wysłaliśmy e-mailem, termin jest zapisany." },
    sendYourself:{ cs:"Rezervaci se nepodařilo odeslat automaticky — pošlete ji prosím tlačítkem níž, nebo zavolejte na +420 773 966 787.",
      en:"We could not submit the booking automatically — please send it with the button below, or call +420 773 966 787.",
      ru:"Отправить запись автоматически не вышло — отправьте её кнопкой ниже или позвоните на +420 773 966 787.",
      uk:"Надіслати запис автоматично не вдалося — надішліть його кнопкою нижче або зателефонуйте на +420 773 966 787.",
      de:"Die Reservierung konnte nicht automatisch übermittelt werden — senden Sie sie bitte mit der Schaltfläche unten oder rufen Sie +420 773 966 787 an.",
      pl:"Nie udało się wysłać rezerwacji automatycznie — proszę wysłać ją przyciskiem poniżej albo zadzwonić na +420 773 966 787." },
